...
if(!ball.stop){
    ball.x += ball.velocitiyX
    ball.y += ball.velocitiyY
}

    
    if(ball.y + ball.r > cvs.height || ball.y - ball.r < 0)
        ball.velocitiyY= -ball.velocitiyY
    ...
    if(collision(ball,player)){
        ...
        ball.velocitiyX = direction * ball.speed * Math.cos(bounceAngle)
        ball.velocitiyY = ball.speed * Math.sin(bounceAngle)
